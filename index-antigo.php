...
.card-content { word-wrap:break-word; hyphens: auto; flex-grow:1; margin-bottom:10px; font-size:0.9em; text-align:justify; line-height:1.5; }
...
<body id="body">
    <main class="container-main">
        <header></header>
        <div class="cabecalho">
            <h1 class="fonte-gothic">Gazeta de Notícias</h1>
        ...
        <div class="div-principal">
            <h6><?php echo $dataExtenso; ?>. Ano I. N. 1.</h6>
            <hr>
    ...
    async function criarCard(item, fonte="padrao", cor='#000', fundo="#FFF", entrelinha="padrao", alinh="padrao", recuoparag="padrao", margem="padrao", padding="padrao") {
        ...
        */
                    const imagem = `<img src="${item.image}" 
                                    ...
                                    loading="lazy">`;
                    const legenda = item.imgrights ? `<p class="img-legenda" style="color: inherit">${item.imgrights}</p>` : "";
                    if(item.url) {
